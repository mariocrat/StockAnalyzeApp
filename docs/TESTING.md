...
Node **20 entrypoint / 160 direct testcase**, `test:broker-import`와 `test:mobile-bundle` 포함.
...
아래 closeout 결과는 2026-09-23, 검증 HEAD `9fff3f3e84ce26f663f41619d37a4eb101bfbc32`의 historical baseline입니다. 현재 작업 tree의 Node inventory는 20 / 160이며, 이번 변경 후 공식 전체 TestOnly 재검증은 대기 중입니다.
