...
- 분석 초점: 결과와 당시 판단의 품질 분리, 진입 가설과 무효화 가격, 손절 기준, 매수·매도 대응, 다음 매매 규칙.
...
- 하루 일반 복기 최대 사용량: 5회.
- 월 일반 복기 최대 사용량: 50회.
- 보상형 광고 5회 시청 시 주 1회 심화 복기 이용권 1장을 지급한다.
- 광고 보상 심화 복기 이용권은 최대 1장까지만 보유한다.
...
| `basic_review_50` | 일반 복기권 50회 | 50 | 4,900원 |
