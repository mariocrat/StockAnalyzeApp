...
기본값은 일반 복기 `gpt-5.4-mini`, 심층 복기 `gpt-5.6-terra`입니다. 출시 직전 OpenAI 공식 모델/가격표가 바뀌었으면 이 두 환경변수만 바꾸면 됩니다.
OpenAI 실행 안전 상한: timeout 최대 90초, 재시도 최대 3회, 재시도 대기 최대 5초.
OpenAI 출력 안전 상한: 일반 복기 기본 1,000토큰, 심층 복기 기본 3,000토큰, 설정 가능한 최대 10,000토큰.
